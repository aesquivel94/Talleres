...
# Carpeta en la que se guardan los resultados (Modificar). 
path_out <- 'D:/OneDrive - CGIAR/Desktop/Costa_Rica/Resampling/Ejemplo_3_CW/results/'


# Path del archivo de probabilidades (Modificar).
Path_Prob <-  'D:/OneDrive - CGIAR/Desktop/Costa_Rica/Resampling/Ejemplo_3_CW/CPT_prob/'
#Path del archivo de estaciones (Modificar).
Path_stations <- 'D:/OneDrive - CGIAR/Desktop/Costa_Rica/Resampling/Ejemplo_3_CW/daily_preliminar/'
# Año objetivo
year_forecast <- Sys.Date() %>% year()
